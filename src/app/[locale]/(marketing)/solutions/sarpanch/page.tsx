...
export default function SarpanchSolutionsPage() {
  const t = useTranslations('Solutions');

  const painPoints = [
    {
      title: t('sarpanchPainPoint1Title'),
      description: t('sarpanchPainPoint1Description'),
    },
    {
      title: t('sarpanchPainPoint2Title'),
      description: t('sarpanchPainPoint2Description'),
    },
    {
      title: t('sarpanchPainPoint3Title'),
      description: t('sarpanchPainPoint3Description'),
    },
    {
      title: t('sarpanchPainPoint4Title'),
      description: t('sarpanchPainPoint4Description'),
    },
  ];
  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16">
      <section className="rounded-3xl border border-governance-navy/10 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-lg text-governance-navy/80">{t('sarpanchIntro')}</p>
        <div className="mt-8">
          <Link
            href="/demo"
