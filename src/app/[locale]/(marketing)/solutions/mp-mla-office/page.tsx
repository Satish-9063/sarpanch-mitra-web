...
export default function MpMlaOfficeSolutionsPage() {
  const t = useTranslations('Solutions');

  const painPoints = [
    {
      title: t('mpMlaPainPoint1Title'),
      description: t('mpMlaPainPoint1Description'),
    },
    {
      title: t('mpMlaPainPoint2Title'),
      description: t('mpMlaPainPoint2Description'),
    },
    {
      title: t('mpMlaPainPoint3Title'),
      description: t('mpMlaPainPoint3Description'),
    },
    {
      title: t('mpMlaPainPoint4Title'),
      description: t('mpMlaPainPoint4Description'),
    },
  ];
  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16">
      <section className="rounded-3xl border border-governance-navy/10 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-lg text-governance-navy/80">{t('mpMlaIntro')}</p>
        <div className="mt-8">
          <Link
            href="/demo"
